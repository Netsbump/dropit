      ...
      <div className="space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h4 className="font-semibold mb-2">
                  {t('sections.donneesCollectees.categories.athlete.title')}
                </h4>
                <ul className="list-disc pl-6 space-y-1">
                  {(
                    t('sections.donneesCollectees.categories.athlete.items', {
                      returnObjects: true,
                    }) as string[]
                  ).map((item: string) => (
                    <li key={item}>{item}</li>
              ...
              <div>
                <h4 className="font-semibold mb-2">
                  {t('sections.donneesCollectees.categories.performance.title')}
                </h4>
                <ul className="list-disc pl-6 space-y-1">
                  {(
                    t(
                      'sections.donneesCollectees.categories.performance.items',
                      { returnObjects: true }
                    ) as string[]
                  ).map((item: string) => (
                    <li key={item}>{item}</li>
              ...
              <div>
                <h4 className="font-semibold mb-2">
                  {t('sections.donneesCollectees.categories.technique.title')}
                </h4>
                <ul className="list-disc pl-6 space-y-1">
                  {(
                    t('sections.donneesCollectees.categories.technique.items', {
                      returnObjects: true,
                    }) as string[]
                  ).map((item: string) => (
                    <li key={item}>{item}</li>
              ...
              <div>
                <h4 className="font-semibold mb-2">
                  {t(
                    'sections.donneesCollectees.categories.organisation.title'
                  )}
                </h4>
                <ul className="list-disc pl-6 space-y-1">
                  {(
                    t(
                      'sections.donneesCollectees.categories.organisation.items',
                      { returnObjects: true }
                    ) as string[]
                  ).map((item: string) => (
                    <li key={item}>{item}</li>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              {(
                t('sections.conservation.durations', {
                  returnObjects: true,
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-primary/10 p-4 rounded-md">
              <p className="font-semibold mb-2">
                {t('sections.droits.exercice.title')}
              </p>
              <ul className="list-disc pl-6 text-sm space-y-1">
                {(
                  t('sections.droits.exercice.methods', {
                    returnObjects: true,
                  }) as string[]
                ).map((method) => (
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-3">
              {(
                t('sections.localisation.infrastructure', {
                  returnObjects: true,
                }) as Infrastructure[]
              ).map((infra) => (
            ...
            <p className="font-semibold text-green-600">
              {t('sections.localisation.transfert')}
            </p>

            <div className="space-y-2">
              <p className="font-semibold">
                {t('sections.localisation.soustraitants.title')}
              </p>
              <p className="text-sm">
                {t('sections.localisation.soustraitants.intro')}
              </p>
              <ul className="list-disc pl-6 text-sm space-y-1">
                {(
                  t('sections.localisation.soustraitants.list', {
                    returnObjects: true,
                  }) as string[]
                ).map((subcontractor) => (
              ...
              <p className="text-sm font-semibold text-primary">
                {t('sections.localisation.soustraitants.engagement')}
              </p>
              <p className="text-sm">
                {t('sections.localisation.soustraitants.partage')}
              </p>
              <ul className="list-disc pl-6 text-sm space-y-1">
                {(
                  t('sections.localisation.soustraitants.conditions', {
                    returnObjects: true,
                  }) as string[]
                ).map((condition) => (
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="font-semibold text-orange-600">
              {t('sections.mineur.consentement')}
            </p>
            <p className="text-sm">{t('sections.mineur.responsabilite')}</p>
            <p className="text-sm text-muted-foreground">
              {t('sections.mineur.verification')}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-md space-y-2">
              <p className="font-semibold">
                {t('sections.reclamation.cnil.name')}
              </p>
              <p className="text-sm">
                {t('sections.reclamation.cnil.address')}
              </p>
              <p className="text-sm">{t('sections.reclamation.cnil.phone')}</p>
              <p className="text-sm">
                <a
                  href={t('sections.reclamation.cnil.website')}
                  target="_blank"
              ...
              <p className="text-sm">
                <a
                  href={t('sections.reclamation.cnil.plainte')}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                >
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <ul className="list-disc pl-6 text-sm space-y-1">
              {(
                t('sections.modifications.moyens', {
                  returnObjects: true,
                }) as string[]
              ).map((moyen) => (
        ...
        <div className="flex justify-center gap-4">
          <Button asChild variant="outline">
            <Link to="/login">
              {t('privacy.buttons.backToLogin', { ns: 'auth' })}
            </Link>
          </Button>
          <Button asChild>
            <Link to="/signup">
              {t('privacy.buttons.signUp', { ns: 'auth' })}
            </Link>
          </Button>
        </div>
      </div>
