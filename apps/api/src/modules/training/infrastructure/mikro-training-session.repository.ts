...
@Injectable()
export class MikroTrainingSessionRepository
  extends EntityRepository<TrainingSession>
  implements ITrainingSessionRepository
{
  ...
  async getByAthleteWithDetails(
    ...
    return await this.em.find(TrainingSession, where, {
      populate: [
        'athletes',
        'athletes.athlete',
        'workout',
