...
import { IAthleteTrainingSessionRepository } from '../application/ports/athlete-training-session.repository.port';
import { Injectable } from '@nestjs/common';

@Injectable()
export class MikroAthleteTrainingSessionRepository
  extends EntityRepository<AthleteTrainingSession>
  implements IAthleteTrainingSessionRepository
{
  ...
  ): Promise<AthleteTrainingSession | null> {
