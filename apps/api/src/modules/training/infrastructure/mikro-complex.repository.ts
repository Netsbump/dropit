...
@Injectable()
export class MikroComplexRepository
  extends EntityRepository<Complex>
  implements IComplexRepository
{
  ...
  async getAll(
    ...
    return await this.em.find(Complex, coachFilterConditions, {
      populate: [
        'complexCategory',
        'exercises',
        'exercises.exercise',
