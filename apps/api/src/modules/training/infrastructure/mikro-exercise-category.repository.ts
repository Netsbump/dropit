...
import { IExerciseCategoryRepository } from '../application/ports/exercise-category.repository.port';
import { Injectable } from '@nestjs/common';
import { CoachFilterConditions } from '../../auth/application/ports/member.repository.port';

@Injectable()
export class MikroExerciseCategoryRepository
  extends EntityRepository<ExerciseCategory>
  implements IExerciseCategoryRepository
{
  ...
  async getAll(
    ...
    return await this.em.find(ExerciseCategory, coachFilterConditions, {
      populate: ['createdBy'],
    });
  }
