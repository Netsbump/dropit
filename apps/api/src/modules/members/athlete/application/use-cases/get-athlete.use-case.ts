...
export class GetAthleteUseCase {
  ...
  async findOneWithDetails(athleteId: string, organizationId: string): Promise<AthleteDetailsDto> {
    ...
    return AthletePresenter.toDtoDetails(athlete);
  }

  async findOne(athleteId: string, organizationId: string): Promise<AthleteDto> {
