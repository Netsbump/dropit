...
const EXERCISE_SEED_DEFINITIONS = [
  // Snatch family
  {
    name: 'Arraché Flexion',
    category: 'Technique',
    englishName: 'Snatch Pull',
    shortName: 'Arr Flex',
  },
  {
    name: "Flexion d'Arraché",
    category: 'Technique',
    englishName: 'Snatch Pull Hang',
    shortName: 'Flex Arr',
  },
  {
    name: 'Arraché',
  ...
  // Jerk family
  {
    ...
    shortName: 'Jeté Fente',
  },
  {
    name: 'Jeté Nuque',
    category: 'Technique',
    englishName: 'Jerk Behind Neck',
    shortName: 'Jeté Nuque',
  },
  ...
  // Tirages
  {
    name: "Tirage Lourd d'Arraché",
    category: 'Technique',
    englishName: 'Snatch High Pull',
    shortName: 'TLA',
  },
  {
    name: "Tirage Lourd d'Epaulé",
    category: 'Technique',
    englishName: 'Clean High Pull',
    shortName: 'TLE',
  },
  {
    name: 'Tirage Nuque',
...
function missingCategoriesMessage(kind: string, names: string[]): string {
  return `Missing ${kind} categories: ${names.join(
    ', '
